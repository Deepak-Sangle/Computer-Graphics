...
void main() {
  ...
  light.shadow = vec3(0.2, 0.2, 0.2);

  Sphere spheres[4];
  spheres[0] = Sphere(vec3(-0.5, 0.1, 0.3), 0.25, vec3(0.0, 1.0, 0.0));
  spheres[1] = Sphere(vec3(0.0,  0.3,-0.4), 0.50,vec3(1.0, 0.0, 0.0));
  spheres[2] = Sphere(vec3(0.5,  0.1, 0.3), 0.25, vec3(0.0, 0.0, 1.0));
  spheres[3] = Sphere(vec3(0.0, -2.3, 0.0), 2.0, vec3(0.4, 0.4, 0.4));
